...
<body>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="table-responsive">
                    <table id="tablaProveedores" class="table table-striped table-bordered table-condensed"
                        style="width:100%">
    ...
    <!--boton facherito-->
    <div class="buttons">
        <a class="button" href="../reportes/proveedores/index.php" target="_blank">Generar PDF</a>
    </div>
    <!--Modal para CRUD-->
                    ...
                    <div class="modal-body">
                        ...
                        <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="empresa" placeholder="Nombre" required>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="cp" placeholder="Codigo postal" required   
                                        pattern="[0-9]{5}" title="Solo numeros.Tamaño: 5 digitos">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        pattern="[0-9]{10}" title="Solo numeros.Tamaño: 10 digitos">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
