...
$result=mysqli_query($link, "select Nombre,Apellido,Direccion,Telefono,Email from empleados"); 
...
while($row = mysqli_fetch_array($result)){ 
    ...
    $pdf->Cell(40,5, $row['Apellido'],1,0,'C');
    $pdf->Cell(40,5, $row['Direccion'],1,0,'C');
